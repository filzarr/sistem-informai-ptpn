<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded bg-white mt-10 py-4">
        ...
        <form class="grid gap-5 mt-5">
            <div class="grid gap-6  md:grid-cols-2">
                <div>
                    <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                        Mesin
                        / Peralatan </label>
                    <input type="text" id="default-input" placeholder="Masukkan Nama Mesin / Peralatan"
            ...
            <div class="grid gap-6  md:grid-cols-3">
                ...
                <div>
                    <label for="perolehan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tahun
                        Perolehan</label>
                    <input type="text" id="perolehan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Masukan Tahun Perolehan Mesin" required>
                </div>
            </div>
            <div class="grid gap-6  md:grid-cols-2">
                <div>
            ...
            <div class="grid gap-6  md:grid-cols-2">
                <div class="">
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih Kategori</label>
                    <select id="countries"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
