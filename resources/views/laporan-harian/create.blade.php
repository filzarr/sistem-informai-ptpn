<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded bg-white mt-10 py-4">
        ...
        <form class="grid gap-10 mt-5" method="POST" action="{{ url('/laporan-harian') }}">
            @csrf
            <div class="grid   gap-4">
                <p class=" text-lg font-semibold text-gray-800">Produksi TBS</p>
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Realisasi" name="realisasi_tbs"
                    placeholder="Masukkan Realisasi tbs (kg)"  ></x-form.number>
                    <x-form.number value=""   label="RKAP" name="rkap_tbs"
                    placeholder="Masukkan RKAP tbs (kg)"  ></x-form.number>
                </div>
            </div>
            <div class="grid   gap-4">
                <p class=" text-lg font-semibold text-gray-800">TBS Di Olah</p>
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="TBS di Olah" name="tbs_olah"
                    placeholder="Masukkan tbs Di Olah (kg)"  ></x-form.number> 
                </div>
            </div>
            <div class="grid   gap-4">
                <p class=" text-lg font-semibold text-gray-800">Sisa TBS</p>
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Pabrik" name="sisa_tbs"
                    placeholder="Masukkan Sisa tbs (kg)"  ></x-form.number> 
                </div>
            </div>
            <div class="grid   gap-4">
                <p class=" text-lg font-semibold text-gray-800">Rendemen Inti Sawit</p>
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Realisasi" name="realisasi_rendemen_inti"
                    placeholder="Masukkan Realisasi Rendemen Inti Sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="RKAP" name="rkap_rendemen_inti"
                    placeholder="Masukkan RKAP Rendemen Inti Sawit (kg)"  ></x-form.number>
                </div>
            </div> 
            <div class="grid   gap-4">
                <p class=" text-lg font-semibold text-gray-800">Produksi Minyak Sawit</p>
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Realisasi" name="realisasi_minyaksawit"
                    placeholder="Masukkan Realisasi minyak sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="RKAP" name="rkap_minyaksawit"
            ...
            <div class="grid   gap-4">
                ...
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Realisasi" name="realisasi_intisawit"
                    placeholder="Masukkan Realisasi Inti Sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="RKAP" name="rkap_intisawit"
            ...
            <div class="grid   gap-4">
                ...
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Realisasi" name="realisasi_rendemen"
                    placeholder="Masukkan Realisasi Rendemen Minyak Sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="RKAP" name="rkap_rendemen"
            ...
            <div class="grid   gap-4">
                ...
                <div class="grid-cols-4 grid gap-3">
                    <x-form.number value=""   label="Minyak Sawit" name="pengiriman_minyaksawit"
                    placeholder="Masukkan Pengiriman Minyak Sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="Inti Sawit" name="pengiriman_intisawit"
                    placeholder="Masukkan Pengiriman Inti Sawit (kg)"  ></x-form.number>
                    <x-form.number value=""   label="Cangkang" name="pengiriman_cangkang"
                ...
                <div class="">
                    ...
                    <select id="countries" name="ptpn"
                        ...
                        <option disabled selected>Pilih Lokasi</option> 
                            <option value="gunung-banyu">Gunung Banyu</option> 
                            <option value="tanah-itam-ulu">Tanah Itam Ulu</option> 
                            <option value="laras">Laras</option> 
                            <option value="bukit-lima">Bukit Lima</option> 
                            <option value="dolok-ilir">Dolok Ilir</option> 
                            <option value="mayang">Mayang</option> 
                            <option value="marihat">Marihat</option> 
                            <option value="tbs p-III">TBS P-III</option> 
