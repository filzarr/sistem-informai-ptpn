    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded bg-white mt-10 py-4">
        <div class="grid grid-cols-4 gap-10">
            <div
                ...
                <div class="grid">
                    <h3 class=" font-semibold text-gray-600">Stok Inti Sawit</h3>
            ...
            <div
                ...
                <div class="grid">
                    <h3 class=" font-semibold text-gray-600">Produksi Inti Sawit Bulan Ini</h3>
            ...
            <div
                ...
                <div class="grid">
                    <h3 class=" font-semibold text-gray-600">Pengiriman Inti Sawit Bulan Ini</h3>
                    <span class="text-sm font-semibold text-gray-500">Belum Ada</span>
                </div>
            </div>
        </div>
        <header class=" flex justify-center mt-7">
            <h3 class=" text-lg font-semibold text-gray-800">Data Produksi/Pengiriman Inti Sawit</h3>
        </header>
            ...
            <div class="flex  justify-between">
                ...
                <div class="flex ">
                    <button type="button"
                        ...
                        Excel</button>
                    <a href="/data-inti-sawit/create">
                        <button type="button"
                            class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded text-sm px-5 py-2.5 text-center me-2 mb-2">Tambah Stok / Kurang Stok</button>
                    </a></div>
            </div>
