    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded bg-white mt-10 py-4">
        ...
        <form class="grid gap-5 mt-5" method="POST" action="{{ url('/analisa') }}">
            ...
            <div class="grid gap-6  md:grid-cols-3">
                <x-form.text value="" formname="vm" label="Masukkan VM (%)" name="vm"
                    placeholder="Masukkan VM (%)" messageerror="VM Belum Diisi"></x-form.text>
                <x-form.text value="" formname="nos" label="Masukkan nos (%)" name="nos"
                    placeholder="Masukkan nos (%)" messageerror="nos Belum Diisi"></x-form.text>
                <x-form.text value="" formname="ffa" label="Masukkan ffa (%)" name="ffa"
                    placeholder="Masukkan ffa (%)" messageerror="ffa Belum Diisi"></x-form.text>
                <x-form.text value="" formname="dobi" label="Masukkan dobi (%)" name="dobi"
                    placeholder="Masukkan dobi (%)" messageerror="dobi Belum Diisi"></x-form.text>
            </div>
            <div class="grid gap-6  md:grid-cols-3">
